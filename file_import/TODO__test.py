...
from file_import.compat import User
from file_import.models import *
...
class SimpleTest(TestCase):
    ...
    def test_import(self):
        ...
        with open(self.absolute_path) as fp:
            response = self.client.post(reverse('file_import-start_import'), {
                'name': 'This is a test',
                'import_file': fp,
                'import_type': "N",
        ...
        self.assertRedirects(response, reverse('file_import-match_columns', kwargs={'import_log_id': ImportLog.objects.all()[1].id}))
    ...
    def test_match_columns(self):
        ...
        response = self.client.post(
            reverse('file_import-match_columns', kwargs={'import_log_id': self.import_log.id}), {
        ...
        self.assertRedirects(response, reverse('file_import-match_relations', kwargs={'import_log_id': self.import_log.id}))
    ...
    def test_match_relations(self):
        ...
        response = self.client.post(
            reverse('file_import-match_relations', kwargs={'import_log_id': self.import_log.id}), {
        ...
        self.assertRedirects(response, reverse('file_import-do_import', kwargs={'import_log_id': self.import_log.id}))
